    ...
    <div className="grid gap-3 p-4 border rounded-2xl bg-white shadow-sm">
      <div className="grid gap-2 sm:grid-cols-2">
        ...
        <div className="grid gap-2">
          ...
          <input className="border rounded-md px-3 py-2" placeholder="https://..." value={url} onChange={(e)=>setUrl(e.target.value)} />
        </div>
      </div>
      ...
      <button className="justify-self-start px-4 py-2 bg-black text-white rounded-xl" onClick={async()=>{
